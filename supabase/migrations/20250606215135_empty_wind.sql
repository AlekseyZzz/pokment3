...
BEGIN
    ...
    DROP POLICY IF EXISTS "Users can insert hands to own sessions" ON hands;
    DROP POLICY IF EXISTS "Users can update own hands" ON hands;
    DROP POLICY IF EXISTS "Users can delete own hands" ON hands;
    
    -- Hand tags policies
    DROP POLICY IF EXISTS "Users can read own hand tags" ON hand_tags;
    DROP POLICY IF EXISTS "Users can insert tags to own hands" ON hand_tags;
    DROP POLICY IF EXISTS "Users can delete own hand tags" ON hand_tags;
    ...
    DROP POLICY IF EXISTS "Users can insert tasks to own goals" ON tasks;
